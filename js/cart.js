...
function get_item(item) {
    return `<div class = "cart-item">
        ...
        <button class="btn btn-danger btn-delete" data-item="${item.title}">Видалити</button> <!-- Delete button -->
...
function showCartList() {
    ...
    deleteButtons.forEach(button => {
        button.addEventListener('click', (event) => {
            ...
            cart.removeItem(itemTitle); // Assume this method is defined in your cart object
            showCartList(); // Refresh the cart list
        });
    });
